...
const flags = [
    ...
    // IT DID MOST OF THE DIFFICULTY RATINGS REALLY STUPID SO A LOT HAVE BEEN OVERHAULED AND WILL CONTINUE TO BE. FEEDBACK IS GREATLY APPRECIATED!
    ...
    { name: "Burkina Faso", code: "bf", difficulty: 5 },
    ...
    { name: "Chad", code: "td", difficulty: 4 },
    ...
    { name: "Cuba", code: "cu", difficulty: 3 },
    ...
    { name: "Lebanon", code: "lb", difficulty: 2 },
    ...
    { name: "Micronesia", code: "fm", difficulty: 4 },
    ...
    { name: "Palestine", code: "ps", difficulty: 2 },
    ...
    { name: "Turkmenistan", code: "tm", difficulty: 4 },
    ...
    { name: "Uruguay", code: "uy", difficulty: 3 },
    ...
    { name: "Kosovo", code: "xk", difficulty: 3 },
